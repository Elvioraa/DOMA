...
from opencood.models.sub_modules.doma_object import (
    attach_collab_doma_pyramid_context,
    build_collab_doma_context,
...
class DOMAHeterPyramidCollab(nn.Module):
    def __init__(self, args):
        super(DOMAHeterPyramidCollab, self).__init__()
        self.args = args
    ...
    def forward(self, data_dict):
        ...
        doma_context = None
        if getattr(self, 'doma_enabled', False):
            if self.doma_flags['quality']:
                doma_context = build_collab_doma_context(
                    self,
                    heter_feature_2d,
                    record_len,
                    affine_matrix,
